    ...
    data = {
        ...
        "experience": [
            ...
            },
            {
                ...
                "endDate": "2020-02",
                "current": False,
                "description": "<ul><li>Built customer-facing SaaS platform from scratch (React + Django)</li><li>Integrated payment processing (Stripe) and email automation</li><li>Achieved 99.9% uptime through monitoring and alerting</li></ul>",
            },
            {
