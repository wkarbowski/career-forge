...
class Settings(BaseSettings):
    ...
    # ── Feature boundaries ───────────────────────────────────────────────
    # Set CLOUD_FEATURES=true when enabling optional extended features.
    # When False (default), optional extended modules
    # are never imported, so the extended modules are never imported when false.
